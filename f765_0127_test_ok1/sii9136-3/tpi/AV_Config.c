...
bool InitVideo(byte TclkSel)
{
	...
	printf("InitVideo: V:%d", (int) VideoModeDescription.VIC);
...
#ifdef DEEP_COLOR
	switch (VideoModeDescription.ColorDepth)
	{
