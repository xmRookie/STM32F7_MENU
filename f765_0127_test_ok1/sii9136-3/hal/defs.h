...
#define CONF__TPI_DEBUG_PRINT   (_DISABLE)
#define CONF__TPI_EDID_PRINT    (_DISABLE)
#define CONF__TPI_TRACE_PRINT	(_DISABLE)
#define CONF__TPI_CDC_PRINT	(_ENABLE)
#define CONF__TPI_TIME_PRINT	(_DISABLE)
...
#if (CONF__TPI_TRACE_PRINT == _ENABLE)
...
#if (CONF__TPI_DEBUG_PRINT == _ENABLE)
...
#if (CONF__TPI_EDID_PRINT == _ENABLE)
...
#if (CONF__TPI_CDC_PRINT == _ENABLE)
...
#if (CONF__TPI_TIME_PRINT == _ENABLE)
